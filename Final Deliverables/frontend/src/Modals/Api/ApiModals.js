...
import { clearUserRegistrationDataFromLocalStorage, fetchUserDataFromLocalStorage, updateUserInfo } from "../../helpers";
...
class ApiRequestsModal {
    ...
    updateProfile = (data, callback) => {
        axiosClient
            .post(EndPoints.profileUpdate, data)
            .then((res) => {
                updateUserInfo(data)
                if (callback) callback(res, true);
            })
